...
// ใช้ Token สำหรับการ Authentication โดยจะใช้ JSON ในการรับส่งข้อมูล
...
exports.register = async (req, res) => {
  try {
    ...
    const latestid = await Users.findOne().sort({id: -1}).exec();
...
exports.login = async (req, res) => {
  try {
    ...
    // var user = await Users.findOneAndUpdate({email}, {ip: ip}, {new: true});
    if (user) {
      ...
      // notifyLINE
      // const text =
      //   "User: " + user.email + " ได้ทำการ Login" + "มาจาก IPAdress:" + ip;
      ...
      // notifyLINE
      // const text = "User: " + email + " พยายาม Login" + "มาจาก IPAdress:" + ip;
